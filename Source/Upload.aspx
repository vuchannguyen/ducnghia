	...
	<script type="text/javascript">
	    $(document).ready(function() {
	        $('#<%= ddlSubject.ClientID %>').change(function(e) {
	            ...
	            if (selectedIndex == 1) {
	                $('#r').css("display", "none");
	                $('#<%= txtboxContactMessage.ClientID%>').hide();
	                $('#lblDes').css("display", "none");
	            }
	            else if (selectedIndex == 2) {
	            $('#r').css("display", "block");
	            $('#<%= txtboxContactMessage.ClientID%>').show('slow');
	            $('#lblDes').css("display", "block");
	            }
	        });
	    }); 
    </script>
    ...
    <div id="contact" class="block_text">
        ...
        <form method="post" >
          <div class="form_settings">
            ...
            <p id="r"><span>test</span><input id="t" type="text" /></p>
            <p id="lblDes"><span>Lời gửi:</span><asp:TextBox ID="txtboxContactMessage" runat="server" Columns="50" Rows="8" CssClass="contact textarea" TextMode="MultiLine"></asp:TextBox></p>
