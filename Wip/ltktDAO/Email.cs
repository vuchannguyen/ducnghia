...
namespace ltktDAO
{
    ...
    public class Pop3Client : IDisposable
    {
        ...
        public Pop3Client(string host, string port, string username, string password)
            : this(host, port, username, password, false)
        {
        }

        public Pop3Client(string host, string port, string username, string password, bool secure)
        {
            Host = host;
            HostPort = port;
            Username = username;
        ...
        public void Connect()
        {
            ...
            if (!Client.Connected)
                Client.Connect(Host, Convert.ToInt32(HostPort));
