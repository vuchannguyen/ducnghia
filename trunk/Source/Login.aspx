    ...
    <div id="loginForm" class="block_text">
        ...
        <form action="Login.aspx" method="post">
          <div class="form_settings">
            <p><span>Tên đăng nhập:</span><asp:TextBox ID="txtboxLoginName" 
                                                       runat="server">
                                                       </asp:TextBox>
            ...
            <p><span>Mật khẩu:</span><asp:TextBox ID="txtboxPassword" 
                                                  TextMode="Password" 
                                                  runat="server">
                                                  </asp:TextBox>
            ...
            <p style="padding-top: 15px"><span>&nbsp;</span><asp:Button ID="btnSubmitLogin" 
                                                                        runat="server" 
