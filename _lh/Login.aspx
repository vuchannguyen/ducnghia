<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="_lh_Login" %>
        ...
        <center>
            ...
            <table class="style1">
                ...
                <tr>
                    ...
                    <td style="width:50%">
                        <asp:TextBox ID="txtboxLoginName" 
                ...
                <tr>
                    <td align="right">
                        <span>Mật khẩu:</span></td>
                    <td>
                       <asp:TextBox ID="txtboxPassword" 
                                    TextMode="Password" 
                                    runat="server" Width="200px">
                                    </asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnSubmitLogin" 
                                    runat="server" 
                                    Text="Đăng nhập" CssClass="submit" OnClick="BtnLogin_Click"/>
                   </td>
                </tr>
            </table>
